...
<head>
    ...
    <body>
        ...
        <div class="tm-home-img-container">
            <img src="image/portfolio/tm-home-img.jpg" alt="Image" class="hidden-lg-up img-fluid">
        </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="image/portfolio/tm-img-310x180-1.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="image/portfolio/tm-img-310x180-2.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="image/portfolio/tm-img-310x180-3.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-content-box">
                            <img src="image/portfolio/tm-img-310x180-4.jpg" alt="Image" class="tm-margin-b-20 img-fluid">
                ...
                <div class="row tm-margin-t-big">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                        <div class="tm-2-col-left">
                            ...
                            <img src="image/portfolio/tm-img-660x330-1.jpg" alt="Image" class="tm-margin-b-40 img-fluid">
                            <p>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="image/portfolio/tm-img-240x120-1.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="image/portfolio/tm-img-240x120-2.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
                                        ...
                                        <div class="media tm-related-post">
                                          <div class="media-left media-middle">
                                            <a href="#">
                                              <img class="media-object" src="image/portfolio/tm-img-240x120-3.jpg" alt="Generic placeholder image">
                                            </a>
                                          </div>
                                          <div class="media-body">
                                            <a href="#"><h4 class="media-heading tm-gold-text tm-margin-b-15">Lorem ipsum dolor</h4></a>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-footer-content-box">
                            ...
                            <div class="tm-margin-b-30">
                                <img src="image/portfolio/tm-img-100x100-1.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="image/portfolio/tm-img-100x100-2.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="image/portfolio/tm-img-100x100-3.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="image/portfolio/tm-img-100x100-4.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="image/portfolio/tm-img-100x100-5.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="image/portfolio/tm-img-100x100-6.jpg" alt="Image" class="tm-footer-thumbnail">
                            </div>
